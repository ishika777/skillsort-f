            ...
            <div className="flex-1 flex flex-col items-center py-6 px-4 md:px-0">
                <div className="w-full max-w-4xl bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div className="flex border-b border-gray-200">
                        <button
                            type="button"
                            className={`flex-1 py-4 font-medium text-sm transition-colors duration-200 ${currentSection === "personalInfo" ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-500 hover:text-gray-700"
                                }`}
                        ...
                        <button
                            type="button"
                            className={`flex-1 py-4 font-medium text-sm transition-colors duration-200 ${currentSection === "education" ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-500 hover:text-gray-700"
                                }`}
