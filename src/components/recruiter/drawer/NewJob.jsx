...
export function NewJob() {
  ...
  return (
    <Drawer direction="right" open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent aria-describedby="new-job-description" className="w-full max-w-md sm:max-w-lg md:max-w-xl p-0 bg-white rounded-lg shadow-lg overflow-y-auto">
